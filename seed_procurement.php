...
// ── 1. Create solution_pages record ──────────────────────────────────────────
...
if ($existing) {
    ...
    $max_order = row('SELECT MAX(sort_order) as m FROM solution_pages WHERE type="department"')['m'] ?? 0;
...
// ── 2. Create/update solution_pages_t record ─────────────────────────────────
...
if ($existing_t) {
    ...
    echo "✅  solution_pages_t: updated title\n";
} else {
...
// ── 3. Create/update Hero / Promo block ───────────────────────────────────────
...
if ($block) {
    ...
    echo "✅  sol_page_blocks: promo block updated\n";
} else {
    ...
    echo "✅  sol_page_blocks: promo block created\n";
}

echo "\nDone. Page is at: /departments/procurement/\n";
