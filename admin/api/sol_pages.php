...
function default_sol_blocks(): array {
    return [
        ['promo',      'Hero / Promo',       0, '{"title":"","text":"","btn1_text":"View Our Presentation","btn1_url":"/assets/Sidis-Group.pdf?v=1","btn2_text":"Free audit","btn2_url":"#getintouch","image_id":null,"image_url":""}'],
        ...
        ['planning',   'Planning / Process', 2, '{"items":[{"title":"Enterprise Resource Planning (ERP)","text":"We help integrate a customized ERP system that includes specialized modules for inventory control, production scheduling, and supply chain management."},{"title":"CRM Integration","text":"Connect your customer data across all touchpoints for a unified view of every client relationship."}],"info_title":"Curious which RPA solution fits your business needs?","info_btn1_text":"View Our Presentation","info_btn1_url":"/assets/Sidis-Group.pdf?v=1","info_btn2_text":"Free audit","info_btn2_url":"#getintouch"}'],
