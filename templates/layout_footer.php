        ...
        <div class="footer__body">
            <div class="footer__head">
                <div class="footer__logo">
                    <img src="./assets/img/logo.svg" alt="SIDIS" loading="lazy">
                </div>
            ...
            <div class="footer__links">
                <a href="#" class="footer__link">
                    ...
                    <svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12.0425 6.08511V3.54513H3.95755L16 12.39V16L3.95755 7.34007V16H0V0H16V8.84006L12.0425 6.08511Z" fill="currentColor"></path>
                    </svg>
                </a>
                <a href="#" class="footer__link">
                    <span>Development</span>
                    <svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.1071 1.92564V3.50379H0V0H13.4122L15.1071 1.92564Z" fill="currentColor"></path>
                        <path d="M15.1071 6.24805H0V9.75184H15.1071V6.24805Z" fill="currentColor"></path>
                        <path d="M15.1071 12.4961V15.9999H1.6949L0 14.0564V12.4961H15.1071Z" fill="currentColor"></path>
                    </svg>
                </a>
            </div>
