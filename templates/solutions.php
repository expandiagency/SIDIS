...
<section id="some-section-2" class="planning" data-scroll-section="">
    <div class="planning__container">
        ...
        <div data-fls-marquee="" data-fls-marquee-space="60" data-fls-marquee-speed="765" class="planning__marquee">
            ...
            <div class="planning__marquee-item"><img alt="Partner" width="150" height="80" loading="lazy" src="/assets/img/automation/partner-2.webp"></div>
            <div class="planning__marquee-item"><img alt="Partner" width="150" height="80" loading="lazy" src="/assets/img/automation/partner-3.webp"></div>
            <div class="planning__marquee-item"><img alt="Partner" width="150" height="80" loading="lazy" src="/assets/img/automation/partner-4.webp"></div>
            <?php endif; ?>
        </div>
